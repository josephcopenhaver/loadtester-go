...
func defaultDoTask(ctx context.Context, lt *Loadtest, workerID int, task Doer) (result taskResultFlags) {
	var err_resp error
...
func defaultRun(ctx context.Context, lt *Loadtest, shutdownErrResp *error) error {
